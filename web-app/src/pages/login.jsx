...
import loginHero from "../assets/banner-home.png";
        ...
        <div className="login-card">
          <div className="login-brand">
            <div className="login-card__hero-wrap">
              <img className="login-card__hero" src={loginHero} alt="Instituto Provincial del Tabaco" />
            </div>
            <div className="login-brand__sub">INSTITUTO PROVINCIAL DEL TABACO</div>
          </div>

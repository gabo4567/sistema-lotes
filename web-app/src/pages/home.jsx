    ...
    <div className="dashboard-home">
      ...
      <section className="dashboard-welcome">
        <div className="welcome-icon">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,12 14,16 9,16C8,16 7.75,15.87 7,15.66C8.81,12.41 10,10 17,8Z" />
          </svg>
        </div>
